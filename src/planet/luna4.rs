//! Core Luna4 planet implementation
//!
//! This module provides the main entry point for creating Luna4 planets
//! and manages the integration between Luna4's internal systems
//! and the common game framework.

use crossbeam_channel::{Receiver, Sender};

use super::cycle::LunarCycle;
use super::energy::EnergyManager;
...
impl Luna4 {
    ...
    pub fn create_planet(
        ...
        let ai = Box::new(crate::planet::luna4::ai::Luna4AI::new(
            self.id,
            self.energy,
            self.resources,
            self.cycle,
